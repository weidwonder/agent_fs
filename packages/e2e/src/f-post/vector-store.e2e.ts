...
import { VectorStore } from '../../../search/src';
    ...
    const docs: VectorDocument[] = [
      {
        ...
        chunk_line_start: chunks[0]?.lineStart || 1,
        chunk_line_end: chunks[0]?.lineEnd || 1,
      ...
      },
      {
        ...
        rel_path: 'b.md',
        file_path: '/beta/b.md',
        chunk_line_start: chunks[1]?.lineStart || 1,
        chunk_line_end: chunks[1]?.lineEnd || 1,
